...
const (
	// Label holds the string label denoting the pos type in the database.
	Label = "pos"
	...
	FieldArea = "area"
	// Table holds the table name of the pos in the database.
	Table = "camera_setup"
)

// Columns holds all SQL columns for pos fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
...
// OrderOption defines the ordering options for the Pos queries.
