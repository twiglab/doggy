...
func (sq *SetupQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (sq *SetupQuery) FirstIDX(ctx context.Context) int {
...
func (sq *SetupQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (sq *SetupQuery) OnlyIDX(ctx context.Context) int {
...
func (sq *SetupQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (sq *SetupQuery) IDsX(ctx context.Context) []int {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SetupQuery) Clone() *SetupQuery {
	...
	return &SetupQuery{
		config:     sq.config,
		ctx:        sq.ctx.Clone(),
		order:      append([]setup.OrderOption{}, sq.order...),
...
func (sq *SetupQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(setup.Table, setup.Columns, sqlgraph.NewFieldSpec(setup.FieldID, field.TypeInt))
	_spec.From = sq.sql
